        ...
        <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[540px]" data-tab-for="order" data-page="active">
                    <thead>
                        <tr>
                            <th class="text-[12px] uppercase tracking-wide font-medium text-gray-400 py-2 px-4 bg-gray-50 text-left rounded-tl-md rounded-bl-md">Order ID</th>
                            <th class="text-[12px] uppercase tracking-wide font-medium text-gray-400 py-2 px-4 bg-gray-50 text-left">Date</th>
                            <th class="text-[12px] uppercase tracking-wide font-medium text-gray-400 py-2 px-4 bg-gray-50 text-left">Customer Name</th>
                    ...
                    <tbody>
                            ...
                            @foreach ($activeOrders as $order)
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">{{ $order->code }}</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">{{ $order->created_at->formatLocalized('%d %B %Y') }}</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">{{ $order->user->full_name }}</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">Rp{{ $order->total_price }}</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                    ...
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">
                                            <button class="bg-blue-200 px-1 rounded text-[12px] text-blue-500">Detail <i class="uil uil-angle-right-b"></i></button>
                                        </span>
                                    </td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
                                <td colspan="5">
                                    <h4 class="flex justify-center items-center py-14 font-semibold text-gray-400">No Active Order Yet</h4>
                                </td>
                            </tr>
                        @endif
                    </tbody>
                ...
                <table class="w-full min-w-[540px] hidden" data-tab-for="order" data-page="completed">
                    ...
                    <tbody>
                        {{-- @if ($completedOrders->count() > 1)
                            @foreach ($completedOrders as $order)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">{{ $order->user->name }}</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">Rp{{ $order->total_price }}</span>
                                    </td>
                        ...
                        @else
                            <tr>
                                <td colspan="5">
                                    <h4 class="flex justify-center items-center py-14 font-semibold text-gray-400">No Completed Order Yet</h4>
                                </td>
                            </tr>
                        @endif --}}
                    </tbody>
                ...
                <table class="w-full min-w-[540px] hidden" data-tab-for="order" data-page="canceled">
                    ...
                    <tbody>
                        ...
                        @else
                            <tr>
                                <td colspan="5">
                                    <h4 class="flex justify-center items-center py-14 font-semibold text-gray-400">No Canceled Order Yet</h4>
                                </td>
                            </tr>
                        @endif --}}
                    </tbody>
